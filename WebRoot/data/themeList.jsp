...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#gridTable").jqGrid({					
			url:'<%=request.getContextPath()%>/cycle_queryThemes.action?edit_date='+dateStr+'&temp='+Math.round(Math.random()*10000),
			datatype: "json",
			height: 500,
			autoheight: true,
	...
	function gridSearch(){
		...
		{
			url:'<%=request.getContextPath()%>/cycle_queryThemes.action'
...
<body>
	<form action="" method="post"">
		<table width="100%" border="0" cellpadding="6" cellspacing="0"
			...
			<tr>
				<td>&nbsp;&nbsp;主题名：<input type="text" id="name"
					name="name" value="" class="input" style="width:150px;" />&nbsp;&nbsp;
				</td>
