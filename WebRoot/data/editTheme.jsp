...
<script type="text/javascript">
  	$(document).ready(function(){
  		var optionsSubmit = {
 	    url:'<%=request.getContextPath()%>/cycle_saveTheme.action',
 	    dataType:'json',
		...
		<fieldset class="fieldsetStyle">
			...
			<div class="fieldsetContent">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<input type="hidden" id="id" name="theme.id" value="${theme.id}" style="width: 500px" />
					<tr>
						<td align="right">主题名：</td>
						<td align="left"><input id="name" name="theme.name" value="${theme.name}" style="width: 500px" /></td>
					</tr>
					<tr>
						<td align="right">描述：</td>
						<td align="left">
							<textarea rows="5" cols="30" id="descs" name="theme.descs">${theme.descs}</textarea>
						</td>
					</tr>
					<tr>
